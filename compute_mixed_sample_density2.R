...
dens <- rtriangle(n[1, "rota"], min_density[1, "rota"], max_density[1, "rota"], mode_density[1, "rota"])
...
#print(nb_microb_in_infected_feces)
  for (duration in durations[[pathogen]]){
    random_density <- rtriangle(n[1, pathogen], min_density[1, pathogen], max_density[1, pathogen], mode_density[1, pathogen])
...
for (pathogen in names(nb_microb_in_infected_feces_list)) {
  ...
  average_pathogen_density_list[[pathogen]] <- nb_microb_in_infected_feces_list[[pathogen]] / 
    (prod_infected_pop_non_infected_feces_list[[pathogen]] + prod_infected_pop_infected_feces_list[[pathogen]])
}
