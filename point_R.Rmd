...
```{r}
df <- data.frame(
  duration_excretion = c(7, 7,exp(1.6), 34, 15, exp(3.6), 10,exp(2.0), exp(4.5), exp(2.1)),
  excretion_density = c(10^(10), 10^(10),exp(20.7), 10^(6), 10^(7.5), exp(13.8), 10^(7), exp(17.3),exp(15.0), exp(5.8)),  
