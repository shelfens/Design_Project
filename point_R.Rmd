...
```{r}
df_log <- data.frame(row.names = c("salmonella_triangular", "salmonella_normal",  "EHEC","rota_triangular", "rota_normal", "giardia", "crypto_triangular", "crypto_normal"))
df_log["log_0"] <- df_responses["response_yearly"]
